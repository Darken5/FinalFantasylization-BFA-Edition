...
------------------------------------------------------------
	...
	EnabledCommand = "on"
	DisabledCommand = "off"
	EnabledtrueMessage = "FinalFantasylization is Enabled."
	EnabledfalseMessage = "FinalFantasylization is Disabled."

	DebugCommand = "debug"
	DebugtrueMessage = "FinalFantasylization: Debug mode is now enabled, to disable type: /FFsound debug."
	DebugfalseMessage = "FinalFantasylization: Debug mode is now disabled."
	
	MusicCommand = "music"
	MusictrueMessage = "FinalFantasylization: All Music is now enabled."
	MusicfalseMessage = "FinalFantasylization: All Music is now disabled, to enable type: /FFsound music."

	SoundCommand = "sound"
	SoundtrueMessage = "FinalFantasylization: All Sounds are now enabled."
	SoundfalseMessage = "FinalFantasylization: All Sounds are now disabled, to enable type: /FFsound sound."
	
	DungeonCommand = "dungeon"
	DungeontrueMessage = "FinalFantasylization: Dungeon music is now enabled."
	DungeonfalseMessage = "FinalFantasylization: Dungeon music is now disabled, to enable type: /FFsound dungeon."

	RaidCommand = "raid"
	RaidtrueMessage = "FinalFantasylization: Raid music is now enabled."
	RaidfalseMessage = "FinalFantasylization: Raid music is now disabled, to enable type: /FFsound raid."
	
	BattlegroundCommand = "battleground"
	BattlegroundtrueMessage = "FinalFantasylization: Battleground music is now enabled."
	BattlegroundfalseMessage = "FinalFantasylization: Battleground music is now disabled, to enable type: /FFsound battleground."
	
	DanceCommand = "dance"
	DancetrueMessage = "FinalFantasylization: Dance music is now enabled."
	DancefalseMessage = "FinalFantasylization: Dance music is now disabled, to enable type: /FFsound dance."
	
	MountCommand = "mount"
	MounttrueMessage = "FinalFantasylization: Mounted music is now enabled."
	MountfalseMessage = "FinalFantasylization: Mounted music is now disabled, to enable type: /FFsound mount."

	CombatCommand = "combat"
	CombattrueMessage = "FinalFantasylization: Combat music is now enabled."
	CombatfalseMessage = "FinalFantasylization: Combat music is now disabled, to enable type: /FFsound combat."

	SleepCommand = "sleep"
	SleeptrueMessage = "FinalFantasylization: Sleep music is now enabled."
	SleepfalseMessage = "FinalFantasylization: Sleep music is now disabled, to enable type: /FFsound sleep."
	
	SwimCommand = "swim"
	SwimtrueMessage = "FinalFantasylization: Swim music is now enabled."
	SwimfalseMessage = "FinalFantasylization: Swim music is now disabled, to enable type: /FFsound swim."
	
	DeadCommand = "dead"
	DeadtrueMessage = "FinalFantasylization: Death music is now enabled."
	DeadfalseMessage = "FinalFantasylization: Death music is now disabled, to enable type: /FFsound death."	
	
	FlightCommand = "flight"
	FlighttrueMessage = "FinalFantasylization: Flight music is now enabled."
	FlightfalseMessage = "FinalFantasylization: Flight music is now disabled, to enable type: /FFsound flight."
	
	CapitalCommand = "capital"
	CapitaltrueMessage = "FinalFantasylization: Capital Cities music is now enabled."
	CapitalfalseMessage = "FinalFantasylization: Capital Cities music is now disabled, to enable type: /FFsound capital."

	FanfareCommand = "fanfare"
	FanfaretrueMessage = "FinalFantasylization: Fanfare sound is now enabled."
	FanfarefalseMessage = "FinalFantasylization: Fanfare sound is now disabled, to enable type: /FFsound fanfare."
	
	ChocoboKwehCommand = "kweh"
	ChocoboKwehtrueMessage = "FinalFantasylization: Chocobo Kweh sound is now enabled."
	ChocoboKwehfalseMessage = "FinalFantasylization: Chocobo Kweh sound is now disabled, to enable type: /FFsound kweh."
	
	LevelUpCommand = "levelup"
	LevelUptrueMessage = "FinalFantasylization: Level Up sound is now enabled."
	LevelUpfalseMessage = "FinalFantasylization: Level Up sound is now disabled, to enable type: /FFsound levelup."
	...
	TestMessage1 = "<< FinalFantasylization Test >> Player Server :  "
   	...
   	TestMessage4 = "<< FinalFantasylization Test >> Instance Classification: "
